          ...
          >
            ...
            <div className="role-options">
              <div className="role-card" onClick={() => handleSelect("user")}>
                <h3>User</h3>
                <p>
                  Create and personalize heartfelt cards, share memories, and
              ...
              <div className="role-card" onClick={() => handleSelect("vendor")}>
                <h3>Vendor</h3>
                <p>
                  Sell your creative products, manage orders, and reach new
                  customers through Best Wishes Marketplace.
                </p>
              </div>
            </div>
